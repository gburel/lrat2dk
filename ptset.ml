...
let map _ = failwith "Ptset.map not implemented"

let of_seq _ = failwith "Ptset.of_seq not implemented"

let add_seq _ = failwith "Ptset.add_seq not implemented"

let to_seq _ = failwith "Ptset.to_seq not implemented"

let to_seq_from _ = failwith "Ptset.to_seq_from not implemented"

let find_last_opt _ = failwith "Ptset.find_last_opt not implemented"

let find_last _ = failwith "Ptset.find_last not implemented"

let find_first_opt _ = failwith "Ptset.find_first_opt not implemented"

let find_first _ = failwith "Ptset.find_first not implemented"

let find_opt a s = try Some (find a s) with Not_found -> None
